...
## Commit History
6332dba feat: complete prototype per specification.
c2b8868 prototype is implemented, task by task, and each step is verified and committed
56da6ec Module 17 Specs
d67fa4a chore: project skeleton for prototypeΓÇÖ
62b7fae Module 16 Docker
7b827b4 Module 15  process each file
095a88d Module 15_Approach 3
64af749 Module 14 fix
3b846c1 Module 14
9914eac Module 14 readme file updated
ef468a3 Module 14
f39aafc Module 13
2b166b1 Module 12
4dbbe8c Module 11
...
206b14c Backlog
bc25c1b Module 8
8b78cc0 Module 8 ProjectConfluence
ab57ac4 up to module 7
2d15ee1 Commit changes up to module 6
44062b9 Add multiply function
0266c44  Initial calculator with add and subtract

## Commit Count
22

## Project Files
The following is the tracked project-file listing with generated dependency trees and package metadata excluded for reviewability. Source files, configuration, documentation, specifications, and package manifests remain included.
...
.github/prompts/to-use-sprint-velocity.prompt.md
.github/prompts/to-use-sprint-workload.prompt.md
.gitignore
.vscode/mcp.json
.vscode/settings.json
ENG_WEEKLY_STATUS.md
PROJECT_IDEAS.md
README.md
STATUS_REPORT_TEMPLATE.md
TODO.md
WEEKLY_SPRINT_REPORT_TEMPLATE.md
backend/Dockerfile
backend/package-lock.json
backend/package.json
backend/src/app.js
backend/src/clients/confluenceClient.js
backend/src/clients/jiraClient.js
backend/src/formatters/confluenceFormatter.js
backend/src/routes/publishRoutes.js
backend/src/routes/reportRoutes.js
backend/src/server.js
backend/src/services/reportBuilder.js
backend/src/services/velocityService.js
backend/src/services/workloadService.js
backlog.md
calculator.py
...
instructions/use-sprint-velocity.agent.md
instructions/use-sprint-workload.agent.md
instructions/validate-instructions.agent.md
main.py
notes.md
project_spec.md
report_generator/__init__.py
report_generator/confluence_client.py
report_generator/formatter.py
report_generator/jira_client.py
...
tools/sprint_velocity.py
tools/sprint_workload.py
...
| Check | Result |
|---|---|
| Specification source | spec/specification.md included in full; 387 lines captured. |
| Commit history source | git log --oneline captured verbatim; 22 commits present. |
| Tracked files source | git ls-files returned 3065 entries. |
| Review file listing | 85 meaningful tracked entries included. |
| Excluded generated entries | 2980 entries excluded: 2980 node_modules files and 2 package metadata files. |
| Specification traceability | spec/checklist.md is included in the project-file listing and records implementation status and evidence. |
| Report generation date | 2026-08-25. |

The filtered file list is intentionally not a byte-for-byte git ls-files paste: it is a review-oriented projection of that command output that removes generated dependency artifacts only.
