...
- When creating skills, generate scripts that retrieve data from the file system and write it to other files during execution — to preserve tokens and minimize hallucinations.
